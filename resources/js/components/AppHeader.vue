...
import { Folder, LayoutGrid, Menu, Search, QrCode, Info, HelpCircle } from 'lucide-vue-next';
...
const rightNavItems: NavItem[] = [
    {
        title: 'Repository',
        href: 'https://github.com/cupyusuf/qris-statis-to-dinamis',
        icon: Folder,
    },
    {
        title: 'Help',
            ...
            <div class="mx-auto flex h-16 items-center px-4 md:max-w-7xl">
                ...
                <div class="lg:hidden">
                    <Sheet>
                        ...
                        <SheetContent side="left" class="w-72 sm:w-80 p-6">
